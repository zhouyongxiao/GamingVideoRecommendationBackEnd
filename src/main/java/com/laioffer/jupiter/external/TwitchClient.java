...
import static com.laioffer.jupiter.entity.ItemType.*;


public class TwitchClient {
    private static final String TOKEN = "Bearer y0jmndwebcvao3j105pexr9h0nf213";
    private static final String CLIENT_ID = "p5bh64nacth98s7c8rall1vem6p3ap";
    ...
    // Similar to getGameList, convert the json data returned from Twitch to a list of Item object.
    ...
    private List<Item> searchClips(String gameId, int limit) throws
    TwitchException {
        List<Item> clips = getItemList(searchTwitch(
