...
public class MySQLConnection implements AutoCloseable {
    ...
    public void setFavoriteItem(String userId, Item item)
        ...
        // first because the foreign key restriction on
        ...
        try {
            ...
            throw new MySQLException(
                    "Failed to save favorite item to database");
        }
    }
    ...
    public void unsetFavoriteItem(String userId, String itemId)
        ...
        String sql = "DELETE FROM favorite_records " +
        ...
        try {
            ...
            e.printStackTrace();
            throw new MySQLException(
                    "Failed to delete favorite item from database"
            );
        }
    ...
    public Set<String> getFavoriteItemIds(String userId)
        ...
        try {
            ...
            e.printStackTrace();
            throw new MySQLException(
                    "Failed to get favorite item ids from database"
            );
        }
    ...
    // Get favorite items for the given user. The returned map
    // includes three entries like {"Videos": [item1, item2, item3],
    // "Stream": [item1, item2, item3],
    // "Clips": [item1, item2, item3]}
    public Map<String, List<Item>> getFavoriteItems(String userId)
        ...
        try {
            ...
            e.printStackTrace();
            throw new MySQLException(
                    "Failed to get favorite items from database"
            );
        }
