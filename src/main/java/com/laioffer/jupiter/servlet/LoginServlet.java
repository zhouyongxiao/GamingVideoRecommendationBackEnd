...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (body == null) {
            System.err.print("User info incorrect");
        ...
        // Create a new session for the user if user ID
        // and password are correct, otherwise return Unauthorized error
        if (!username.isEmpty()) {
            // Create a new session, put user ID as an attribute into the
            // session object, and set the expiration time to 600 seconds.
